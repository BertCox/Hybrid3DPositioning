/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     GPIOTrigger
  * - <b>Project file</b>:     C:/Users/Bert/Documents/Texas Instruments/Sensor Controller Studio/projects/GPIOtrigger.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2021-02-25 15:16:33.077
  * - <b>Computer</b>:         BERT-PC
  * - <b>User</b>:             Bert
  *
  ...
  * Pin Triggered Binary GPIO sampling
  *
  *
  * \subsection section_io_mapping I/O Mapping
  * Task I/O functions are mapped to the following pins:
  * - binarySampling:
  *     - <b>I: Trigger input</b>: DIO1
  *     - <b>I: Sample Input</b>: DIO27
  *     - <b>O: Pin to test speed</b>: DIO28
  *
  *
  ...
  *
  *
  * \subsection section_task_desc_binary_sampling binarySampling
...
/// binarySampling: Task ID
#define SCIF_BINARY_SAMPLING_TASK_ID 0


/// binarySampling: Array of 512, 16 bit samples
#define SCIF_BINARY_SAMPLING_ARRAY_SIZE 32
/// binarySampling I/O mapping: Trigger input
#define SCIF_BINARY_SAMPLING_DIO_I_INPUT_TRIGGER 1
/// binarySampling I/O mapping: Sample Input
#define SCIF_BINARY_SAMPLING_DIO_I_INPUT_SAMPLING 27
/// binarySampling I/O mapping: Pin to test speed
#define SCIF_BINARY_SAMPLING_DIO_O_PIN_LED 28
...
/// binarySampling: Task output data structure
typedef struct {
    uint16_t outputArray[32]; ///< array of 512 bits with binary sampled data
} SCIF_BINARY_SAMPLING_OUTPUT_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_BINARY_SAMPLING_OUTPUT_T output;
    } binarySampling;
} SCIF_TASK_DATA_T;
